/* eslint no-unsafe-finally: "off", no-func-assign: "off" */
'use strict'
...
startObserving = function startObserving(el, binding) {
  ...
  if (
    (binding != null
      ? (ref = binding.value) != null
        ? ref.disabled
        : void 0
      : void 0) ||
    directive.defaults.disabled ||
    disabled
  ) {
...
makeObserver = function makeObserver(el, _ref) {
  ...
  margin =
    typeof value === 'string'
      ? value
      : value.margin || directive.defaults.margin // Make the observer callback
...
update = function update(_ref4) {
  ...
  if (!root) {
    inViewport =
      ...
      el.getBoundingClientRect().top < document.documentElement.clientHeight
  } else {
...
export default directive = {
  ...
  // Init
  created: function inserted(el, binding) {
